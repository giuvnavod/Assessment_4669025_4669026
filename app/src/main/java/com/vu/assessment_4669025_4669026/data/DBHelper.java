package com.vu.assessment_4669025_4669026.data;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CAR_INFORMATION = "CREATE TABLE " + TABLE_NAME
                + "(" + CAR_ID + " INTEGER " + "PRIMARY KEY AUTOINCREMENT, "
                + CAR_BRAND + " TEXT, "
                + CAR_MODEL + " TEXT, "
                + CAR_PRICE + " INTEGER)";

        db.execSQL(CREATE_CAR_INFORMATION);
    }
    ...
    public boolean addCar(String brand, String model, int price) {
    ...
    @SuppressLint("Range")
    public int checkPrice(String brand, String model) {
